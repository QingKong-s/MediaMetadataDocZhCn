...
- [ID3标签2.4.0版 - 主要结构](#id3标签240版---主要结构)
  - [本文件的地位](#本文件的地位)
  - [内容摘要](#内容摘要)
  - [备注](#备注)
- [1.目录](#1目录)
...
- [4.ID3v2帧概述](#4id3v2帧概述)
  - [4.1.帧头标志](#41帧头标志)
    - [4.1.1.帧状态标记](#411帧状态标记)
    - [4.1.2.帧格式标记](#412帧格式标记)
- [5.标签位置](#5标签位置)
- [6.非同步](#6非同步)
  - [6.1.非同步方案](#61非同步方案)
  - [6.2.同步安全整数](#62同步安全整数)
...
- [9.附录](#9附录)
  - [A.附录A - 与ID3v2.3的不同](#a附录a---与id3v23的不同)
    - [A.1.ID3v2.4中的新增结构](#a1id3v24中的新增结构)
    - [A.2.ID3v2.3和ID3v2.4中都存在但不同的结构](#a2id3v23和id3v24中都存在但不同的结构)
      - [A.2.1.ID3v2.3扩展头](#a21id3v23扩展头)
      - [A.2.2.帧](#a22帧)
